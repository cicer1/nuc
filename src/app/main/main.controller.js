...
angular.module('nuc')
  .controller('MainCtrl', [ '$timeout', '$interval', '$scope', '$location', '$routeParams', '$anchorScroll', '$rootScope','$window',function ($timeout,$interval, $scope, $location, $routeParams, $anchorScroll, $rootScope, $window) {
